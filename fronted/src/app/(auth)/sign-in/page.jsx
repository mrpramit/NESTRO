  ...
  return (
    <div className="w-full max-w-[440px] bg-white border border-[#EFE8DF] rounded-[24px] p-5 md:p-6 shadow-xl shadow-[#8C6239]/4 space-y-4">
      ...
      <div className="space-y-1">
        <h2 className="text-xl font-bold text-[#281C19] tracking-tight">
          Welcome back
        </h2>
      ...
      <div className="relative flex items-center justify-center py-1">
        ...
        <span className="relative bg-white px-3 text-[10px] font-bold text-[#8A7973] uppercase tracking-wider">
          or
        </span>
      </div>
      ...
      <div className="relative flex items-center justify-center py-0.5">
        ...
        <span className="relative bg-white px-3 text-[9px] font-bold text-[#8A7973]/60 uppercase tracking-wider">
          Admin
        </span>
      </div>
      ...
      <div className="text-center">
        ...
        >
          <svg
            className="w-3 h-3 text-[#8C6239] group-hover:scale-110 transition-transform"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
